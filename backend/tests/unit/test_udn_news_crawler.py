...
class TestUDNCrawler(unittest.TestCase):
    ...
    def test_fetch_news_data(self, mock_get):
        ...
        headlines = self.scraper._fetch_news(search_page=1, search_term="technology")
    ...
    def test_create_search_params(self):
        params = self.scraper._create_search_params(search_page=1, search_term="technology")
        self.assertEqual(params["page"], 1)
        self.assertEqual(params["id"], f"search:{quote('technology')}")
